// Routine to calculate 16-bit CCITT standard CRC for blocks of data sent by
// Vantage Pro(TM) weather station
...
// CRC table (follows 16-bit CCITT standard)
...
// Calculate 16-bit CRC for block of data
